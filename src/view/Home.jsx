            ...
            <div className={"h-fit overflow-y-scroll"}>
                ...
                <div className={"p-4 font-Poppins"}>
                    <div className={"flex pb-4 block items-center justify-between"}>
                        <span className={"font-[600] text-md"}>Historical Places</span>
                        <span className={"text-sm font-[500] text-gray-600"}>View all</span>
                    </div>
                ...
                <div className={"p-4 font-Poppins"}>
                    <div className={"flex pb-4 block items-center justify-between"}>
                        <span className={"font-[600] text-md"}>Sight Seeing</span>
                        <span className={"text-sm font-[500] text-gray-600"}>View all</span>
                    </div>
                    <div className={"overflow-x-scroll hide-scroll"}>
                        <div className={"flex w-fit"}>
